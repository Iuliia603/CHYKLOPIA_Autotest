...
class WebSolutionsPage:
    def __init__(self, browser):
        self.header = Header(browser)
        self.homepage = HomePage(browser)

        self.web_solutions_title = Element(browser, By.XPATH,'//*[@id="content"]/div/div[1]/section[1]/div[2]/div[1]/div/div[1]/div/p')

    def get_web_solutions_title(self):
        return self.web_solutions_title.get_text()